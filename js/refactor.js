...
// Put your answer below -------------------------
  // [c]: z then y
  // - The letter variable is redefined after the first *declaration???*
  // - The setTimeout delays the first log so the log outside of that
  //   function would execute first.
// -----------------------------------------------
